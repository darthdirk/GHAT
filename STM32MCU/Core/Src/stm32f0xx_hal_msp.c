...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = SCL_temp_sensor_Pin|SDA_temp_sensor_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(SCL_temp_sensor_GPIO_Port, SCL_temp_sensor_Pin);

    HAL_GPIO_DeInit(SDA_temp_sensor_GPIO_Port, SDA_temp_sensor_Pin);
